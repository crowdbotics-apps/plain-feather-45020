"""
Django settings for plain_feather_45020 project.
...
ROOT_URLCONF = 'plain_feather_45020.urls'
...
WSGI_APPLICATION = 'plain_feather_45020.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "plain_feather_45020 API",
    "DESCRIPTION": "API documentation for plain_feather_45020 App",
    "VERSION": "v1",
}
